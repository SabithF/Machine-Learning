...
# NumPy routines which allocate memory and fill with user specified values
a = np.array([[5,3], [4,3], [3,2]]);   print(f" a shape = {a.shape}, np.array: a = {a}")
...
#vector indexing operations on matricec 
...
#access a row
print(f"a[2].shape:   {a[2].shape}, a[2]   = {a[1]}, type(a[2])   = {type(a[2])}")
...
print("a[1, 2:7:1] = ", a[1, 2:7:1], ",  a[1, 2:7:1].shape =", a[1, 2:7:1].shape, "a 1-D array")
